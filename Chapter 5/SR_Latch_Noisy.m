...
Oscillator_Inputs = [0 0 0 I_C % Start by providing an input just to O_2 (to make it oscillate). 
                     0 0 I_C I_C % Then provide the input to O_1 as well (shouldn't yet begin to oscillate, as it should be inhibited by O_2). 
                     1 0 I_C I_C % Then an input is provided to I_1 (set the latch).
                     0 0 I_C I_C % See the continuing output. 
                     0 1 I_C I_C % Then reset the latch. 
                     0 0 I_C I_C]; % Then see the outputs.

% Same Purpose as above, just reversing the operations in comparison to what they should be. 
Oscillator_Inputs2 = [0 0 I_C 0 
                     0 0 I_C I_C  
                     0 1 I_C I_C 
                     0 0 I_C I_C  
                     1 0 I_C I_C  
